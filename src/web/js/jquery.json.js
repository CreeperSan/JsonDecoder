...
var JSONFormat = (function(){
    ...
    function _format_array(object, indent_count){
        ...
        return '<span data-type="array" data-size="' + tmp_array.length + '"><img  style="cursor:pointer;" src="./res/icon/minus.png" class="json-ops-icon" onclick="hide(this)"></img>[<br/>'
            + tmp_array.join(',<br/>')
    ...
    function _format_object(object, indent_count){
        ...
        return '<span  data-type="object"><img  style="cursor:pointer;" src="./res/icon/minus.png" class="json-ops-icon" onclick="hide(this)"></img>{<br/>'
            + tmp_array.join(',<br/>')
            + '<br/>' + indent_tab(indent_count - 1) + '}</span>';
    }
...
function hide(obj){
    ...
    if (data_type === 'array') {
        ...
        obj.parentNode.innerHTML = '<img  style="cursor:pointer;" class="json-ops-icon" src="./res/icon/plus.png" onclick="show(this)"></img>Array[<span class="json_number">' + data_size + '</span>]';
    }else{
        // obj.parentNode.innerHTML = '<i  style="cursor:pointer;" class="fa fa-plus-square-o" onclick="show(this)"></i>Object{...}';
        obj.parentNode.innerHTML = '<img  style="cursor:pointer;" class="json-ops-icon" src="./res/icon/plus.png" onclick="show(this)"></img>Object{...}';
    }
